...
{
    Task<RecordingSession?> GetRecordingSessionAsync(Guid recordingId, CancellationToken cancellationToken = default);
    ...
    Task<bool> UpdateRecordingMetadataAsync(RecordingId recordingId, RecordingMetadata metadata, CancellationToken cancellationToken = default);
